...
`
export const FillterGroup = styled.div`
  padding: 20px 0;
  border-bottom: 1px solid rgba(0, 0, 0, 0.09);
`
export const FillterPriceHeader = styled.div`
  margin-bottom: 1rem;
`
...
export const PriceRangeLine = styled.div`
  ...
  margin: 0 1rem;
`
export const PriceErr = styled.div`
  padding: 1rem 0;
  text-align: center;
  color: #ff424f;
  font-size: 1.2rem;
...
export const PriceButton = styled(Button)`
  ...
  width: 100%;
`
export const RemoveFillterBtn = styled(PriceButton)``
