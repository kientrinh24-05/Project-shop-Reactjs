...
`
export const productItemsPrice = styled.div`
  display: flex;
  align-items: center;
  overflow: hidden;
  padding-top: 0.5rem;
  margin-bottom: 1rem;
`
export const productItemsPriceOriginal = styled.div`
  flex-shrink: 1;
  max-width: 50%;
  ...
  text-overflow: ellipsis;
`
export const productItemsPriceSales = styled.div`
  flex-grow: 1;
  color: #ee4d2d;
  white-space: nowrap;
  overflow: hidden;
...
`
export const productItemsMeta = styled.div`
  display: flex;
  justify-content: flex-end;
`
export const productItemsSold = styled.div`
